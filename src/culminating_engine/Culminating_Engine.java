...
//        }, new Vector3(0,1,1));
        ...
        GameObject box = new RectangularPrism(new Vector3(10,0,0), 5,7,6);
        GameObject tri = new GameObject(new Face[] {
             new Face(new Vector3(5,0,0), new Vector3(6,0,0),new Vector3(0,5,0))
             }, new Vector3(0,0,0));
        
        box.rotateAroundSelf(PI/7, PI/1.4, PI/2.3);
        GameObject[] world = {box};
        
        Camera c = new Camera(new Vector3(0,0,0), Math.toRadians(30), new Vector3(1,0,0));
